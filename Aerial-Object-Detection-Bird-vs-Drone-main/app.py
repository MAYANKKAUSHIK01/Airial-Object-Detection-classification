...
def load_cnn_model():
    with st.spinner("Loading model..."):
        time.sleep(1)
        try:
            model = load_model("/Aerial-Object-Detection-Bird-vs-Drone-main/best_model.keras")
...
def load_yolo_model():
    try:
        MODEL_PATH = "/Aerial-Object-Detection-Bird-vs-Drone-main/yolo11n.pt"  # change if needed
